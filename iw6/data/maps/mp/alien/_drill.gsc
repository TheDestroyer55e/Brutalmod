...
set_drill_state_run( var_0 )
{
	...
	if ( maps\mp\alien\_persistence::get_cheats_value(1) == 1 )
		level.duration_multiplier = 0.001;
	else if ( getdvarint( "scr_aliens_promode" ) == 1 && level.realcyclenum >= 10 )
...
monitor_drill_complete( var_0 )
{
	...
	if ( maps\mp\alien\_persistence::get_cheats_value(1) == 1 )
		...
		level.duration_multiplier = 1.4;
	else if ( getdvarint( "scr_aliens_promode" ) >= 1 && level.realcyclenum == 15 && getdvar( "mapname" ) == "mp_alien_armory" )
		level.duration_multiplier = 1.16;
	else
		level.duration_multiplier = 1;
...
handle_bomb_damage()
{
    ...
    for (;;)
    {
        ...
        if ( var_5 <= 20 && var_6.alien_type == "locust" )
            level.drill_last_health = level.drill_last_health - int(floor(var_5 * 1.8));
        else if ( isdefined( var_6 ) && isai( var_6 ) )
